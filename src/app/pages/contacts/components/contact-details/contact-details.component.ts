...
export class ContactDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    ).subscribe(_ => this.router.navigate(['/poc-event-driven/contacts']));
  ...
  editContact(contact: Contact) {
    this.router.navigate(['/poc-event-driven/contacts', contact.id, 'edit']);
  }
  ...
  deleteContact(contact: Contact) {
    ...
    if (r) {
      ...
      this.router.navigate(['/poc-event-driven/contacts'])
    }
  }
